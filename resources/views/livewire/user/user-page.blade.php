<section class="p-3 sm:p-5">
    ...
    <div class="mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <!-- Pagination -->
            <div class="p-4">
                {{ $this->users->links('vendor.pagination.custom-paginate') }}
            </div>
    ...
    <!-- Main modal -->
    <div id="defaultModal" tabindex="-1" aria-hidden="true" wire:ignore.self
                ...
                <form wire:submit.prevent="saved">
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" wire:model="nip" name="nip" id="nip" autocomplete="off"
                                class="@error('nip') border-red-500 @enderror border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Type user NIP">
                            @error('nip')
                        ...
                        <div>
                            ...
                            <select id="position" wire:model="position" name="position"
                                class="@error('position') border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        ...
                        <div>
                            ...
                            <input type="password" wire:model="password" password="password" id="password"
                                autocomplete="off"
